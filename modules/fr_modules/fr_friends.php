								...
								<div class="central-meta">
									<div class="frnds">
										<ul class="nav nav-tabs">
											 <li class="nav-item"><a class="active" href="#fr_frends" data-toggle="tab">Friends</a> <span class="friendz-count"></span></li>
										...
										<div class="tab-content">
										  <div class="tab-pane active fade show " id="fr_frends" >
											...
											<!-- <li>
												<div class="nearly-pepls">
													...
													<div class="pepl-info">
														...
														<a href="#" title="" class="add-butn unfriend" data-ripple="">unfriend</a>
													</div>
												</div>
											</li>
											<li>

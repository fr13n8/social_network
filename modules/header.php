		...
		<div class="feature-photo">
			...
			<form class="edit-phto">
				...
				<label class="fileContainer">
					Edit Cover Photo
					<input id="background" type="file" multiple="multiple" accept=".txt,image/*"/>
				</label>
			</form>
				...
				<div class="row merged">
					<div class="col-lg-2 col-sm-3">
						<div class="user-avatar">
							<figure>
								<img src="" id="u_avatar" alt="">
								<form class="edit-phto" style="cursor: pointer;">
									<i class="fa fa-camera-retro"></i>
									<label class="fileContainer">
										Edit Display Photo
										<input id="avatar" type="file" multiple="multiple" accept=".txt,image/*"/>
									</label>
								</form>
							</figure>
						</div>
						...
						<div class="timeline-info">
							<ul>
								...
								<li>
									...
									<a class="" id="photo-page" href="timeline-photos.php" title="" data-ripple="">Photos</a>
									<!-- <a class="" href="timeline-videos.html" title="" data-ripple="">Videos</a> -->
									<a class="" id="friend-page" href="timeline-friends.php" title="" data-ripple="">Friends</a>

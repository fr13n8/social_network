									...
									<div class="editing-info">
										...
										<form method="post">
											<div class="form-group half">	
											  <input type="text" id="u_nameChange" required="required"/>
											  <label class="control-label" for="input">First Name</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group half">	
											  <input type="text" id="u_surnameChange" required="required"/>
											  <label class="control-label" for="input">Last Name</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group">	
											  <input type="text" id="u_emailChange" required="required"/>
											  <label class="control-label" for="input">E-Mail</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group">	
											  <input type="text" id="u_phoneChange" required="required"/>
											...
											<div class="form-radio" id="form-radio">
											  <div class="radio">
												<label>
												  <input type="radio" checked="checked" value="male" name="gender"><i class="check-box"></i>Male
												</label>
											  </div>
											  <div class="radio">
												<label>
											...
											<div class="form-group">	
											  <input type="text" id="u_city" required="required"/>
											...
											<div class="form-group">	
											  <textarea rows="4" id="u_aboutChange" required="required"></textarea>
											...
											<div class="submit-btns">
												...
												<button type="button" id="u_dataChange" class="mtr-btn"><span>Update</span></button>
											</div>
										</form>
									</div>
								</div>	
